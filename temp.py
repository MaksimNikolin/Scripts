...
def get_battery_status():
    try:
        ...
        if capacity is not None and capacity != "N/A":
            capacity = capacity.replace('%', '').strip()
...
def update_temperatures():
    ...
    battery_label.config(text=f"Battery Capacity: {battery_info.get('capacity', 'N/A')}% | Level: Normal")
